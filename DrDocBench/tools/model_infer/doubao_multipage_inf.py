"""
Multi-page sliding-window Doubao img2md inference.
...
def main():
    parser = argparse.ArgumentParser(description="Multi-page sliding-window Doubao inference for document images")
